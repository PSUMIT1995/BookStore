                ...
                using (sqlConnection)
                {
                    ...
                    if (sqlDataReader.HasRows)
                    {
                        while (sqlDataReader.Read())
                        {
                            ...
                            addresses.AddressId = (int)sqlDataReader["AddressId"];
                            addresses.Address = sqlDataReader["Address"].ToString();
                            addresses.City = sqlDataReader["City"].ToString();
                            addresses.State = sqlDataReader["State"].ToString();
                            addresses.TypeId = (int)sqlDataReader["TypeId"];
